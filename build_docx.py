...
body.append(para("Below the Transaction Log (rows 49-62) is an auto-posted Interest ledger - one line per account, "
...
body.append(formula_table([
    ("A49:A62", "TODAY()", "Date of the interest snapshot (auto)."),
    ("B49:B62", "(text) Interest", "Transaction type."),
    ("E49:E62", "IFERROR(VLOOKUP(D49,Interest!$D$6:$Q$19,13,FALSE),0)",
    ...
    ("E63", "SUM(E49:E62)", "Total interest earned to date across all accounts."),
]))
